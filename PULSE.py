...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=1DqGyp72FMp2sr2TgyB6mOxXPcq3OpjYy", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=1rl8UF4Pk8q98b6_fL8zRT3K0VD0xC_FP", cache_dir=cache_dir, verbose=verbose) as f:
